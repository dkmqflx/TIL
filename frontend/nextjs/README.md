...
- [Next.js Documentation - Server Components](https://nextjs.org/docs/14/app/building-your-application/rendering/server-components#how-are-server-components-rendered)
...
- [리액트 서버 컴포넌트 톺아보기 (번역)](https://roy-jung.github.io/250323-react-server-components/)
...
- [Caching in Next.js](https://nextjs.org/docs/14/app/building-your-application/caching)
